  ...
  <div v-if="showDelete" class="fixed z-10 inset-0 overflow-y-auto">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
        ...
        <span v-on:click="deleteItem" class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
          ...
          <span v-on:click="show = false" class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
